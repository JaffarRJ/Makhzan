...
use App\Http\Requests\Api\Account\ListingRequest;
use App\Http\Requests\Api\Account\StoreRequest;
use App\Http\Requests\Api\Account\UpdateIsActiveRequest;
use App\Http\Requests\Api\Account\UpdateIsShowRequest;
...
class AccountController extends Controller
{
    ...
    /**
     * @OA\GET(
     *      path="/api/admin/account/listing",
     *      operationId="account-listing",
     *      tags={"admin,account,listing"},
     *      summary="account",
     *       security={
     *           {"bearerAuth": {}}
     *       },
    ...
    /**
     * @OA\GET(
     *      path="/api/admin/account/detail",
     *      operationId="account-detail",
     *      tags={"admin,account,detail"},
     *      summary="account",
     *       security={
     *           {"bearerAuth": {}}
     *       },
    ...
    /**
     * @OA\POST(
     *      path="/api/admin/account/store",
     *      operationId="account-store",
     *      tags={"admin,account,store"},
     *      summary="account",
     *       security={
     *           {"bearerAuth": {}}
     *       },
    ...
    /**
     * @OA\POST(
     *      path="/api/admin/account/UpdateIsActive",
     *      operationId="account-UpdateIsActive",
     *      tags={"admin,account,UpdateIsActive"},
     *      summary="account",
     *       security={
     *           {"bearerAuth": {}}
     *       },
    ...
    /**
     * @OA\POST(
     *      path="/api/admin/account/updateIsShow",
     *      operationId="account-updateIsShow",
     *      tags={"admin,account,updateIsShow"},
     *      summary="account",
     *       security={
     *           {"bearerAuth": {}}
     *       },
